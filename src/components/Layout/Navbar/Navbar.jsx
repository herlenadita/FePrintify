...
export default function Navbar() {
  ...
  const goToDocumentation = async () => {
    window.open("/doc/RND-API Documentation-211224-143238.pdf", "_blank");
  };
  return (
        ...
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex space-x-4">
                ...
                <a href="#" className="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white" onClick={goToDocumentation}>Documentation</a>
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            ...
            <div className="relative ml-3">
              <div className="flex space-x-4">
                <a href="#"  onClick={handleLogout} className="rounded-md bg-gray-900 px-3 py-2 text-sm font-medium text-white">Logout</a>
              </div>
            </div>
          </div>
        </div>
...
{/* <div classNameName='absolute w-full border-t-4 border-blue-500 bg-white '>
  <div classNameName='border-b border-gray-300'>
    <div classNameName='flex max-w-6xl mx-auto'>
      <span classNameName='py-4 px-4 text-2xl font-semibold text-blue-500'>
        POSTMAN CLONE
      </span>
    </div>
  </div>
